...
namespace NorthwestLabs.Controllers
{
    public class AssaysController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Assay_ID,Assay_Name,Base_Cost,Assay_Description")] Assay assay)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Assay_ID,Assay_Name,Base_Cost,Assay_Description")] Assay assay)
        {
            if (ModelState.IsValid)
            {
